...
> **Plan status:** Non-canonical completion plan. The implemented subset is
> documented in [`docs/language/ranges.md`](../language/ranges.md).
...
[`docs/language/grammar.ebnf`](../language/grammar.ebnf), ownership and loans in
[`docs/language/ownership-and-lifetimes.md`](../language/ownership-and-lifetimes.md),
and compiler phase authority in
[`docs/architecture/overview.md`](../architecture/overview.md). This proposal
...
[`docs/architecture/overview.md`](../architecture/overview.md) remain
