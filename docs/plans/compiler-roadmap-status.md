...
select that identity independently of declaration order; HIR and the C++
backend only preserve the selection. Partial specialization, specialization
ranking, SFINAE, and constraint-selected specialization remain outside the
language.
