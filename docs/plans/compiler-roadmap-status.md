...
record. The first M-FAIL-01 implementation slice now assigns exact semantic,
HIR, and MIR local-origin/propagation identity and verifier/effect rules. It
does not yet change current execution: the emitter still aborts without
cleanup/location/category preservation and wrong-state expected access still
inherits native behavior until the remaining M-EXEC-01 work, M-FAIL-01's
site/CFG/runtime slices, co-delivered Q-FAIL-01, and complete M-BACK-02 body
migration land; M-LIFE-01 is complete.
