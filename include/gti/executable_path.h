...
inline std::filesystem::path nativeExecutablePath() {
#if defined(_WIN32)
...
inline std::filesystem::path executableFromArgument(const char *driver) {
...
inline std::filesystem::path executablePath(const char *driver) {
