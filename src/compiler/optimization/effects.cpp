...
constexpr auto operationEffects = std::to_array<MirEffectTraits>({
    ...
    MirEffectTraits{.copiesValue = true, .initializesValue = true},
    harmless(), // Comma
    trapping(), // Add: overflow semantics remain an optimizer gate.
    trapping(), // Subtract
    trapping(), // Multiply
    trapping(), // Divide
    trapping(), // Remainder
...
constexpr auto operationNames = std::to_array<std::string_view>({
    "none",          "literal",        "enum-constant",   "aggregate",
    "index",         "identity",       "convert",         "expected-value",
    "closure",       "pack-expansion", "unexpected",      "comma",
    "add",           "subtract",       "multiply",        "divide",
    "remainder",     "bitwise-and",    "bitwise-or",      "bitwise-xor",
    "shift-left",    "shift-right",    "equal",           "not-equal",
    "less",          "less-equal",     "greater",         "greater-equal",
    "positive",      "negate",         "logical-not",     "bitwise-not",
    "assign",        "add-assign",     "subtract-assign", "pre-increment",
