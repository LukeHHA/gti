...
_Static_assert(
    _Generic(&gti_rt_read_stdin_byte, int32_t (*)(void): 1, default: 0),
    "the stdin runtime entry must retain its C prototype");
_Static_assert(
    _Generic(&gti_rt_read_file_byte, int32_t (*)(int64_t): 1, default: 0),
    "the file-read runtime entry must retain its C prototype");
_Static_assert(
    _Generic(&gti_rt_close_file, int32_t (*)(int64_t): 1, default: 0),
