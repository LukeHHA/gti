...
requireCapture(202, "union", "keyword.type");
requireCapture(202, "Bits", "type.definition");
requireCapture(203, "integer", "variable.member");
requireCapture(207, "Event", "type.definition");
requireCapture(209, "point", "constant");
requireCapture(209, "x", "variable.parameter");
...
requireLocalCapture(202, "Bits", "local.definition.type");
requireLocalCapture(203, "integer", "local.definition.field");
requireLocalCapture(207, "Event", "local.definition.type");
requireLocalCapture(209, "x", "local.definition.parameter");
requireLocalCapture(209, "y", "local.definition.parameter");
